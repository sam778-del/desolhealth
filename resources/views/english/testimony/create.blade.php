...
@section('content')
    <div class="page-content container-fluid">
        <div class="row">
            <div class="col-md-9">
                <form method="POST" action="{{ route('testimony_create') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <input type="text" class="form-control" id="title" name="position" placeholder="Position" value="">
                        </div>
                    </div>
                    <div class="panel">
                        <div class="panel-heading">
                        ...
                        <div class="panel-body">
                            <input type="text" class="form-control" id="title" name="title" placeholder="Client Name" value="">
                        </div>
                    </div>
                    <div class="panel">
                        <div class="panel-heading">
