...
@section('content')
    <div class="page-content container-fluid">
        <h1 class="page-title">
            <i class="voyager-news"></i> Faq
        </h1>
        <a href="{{ route('faq.create') }}" class="btn btn-success btn-add-new">
                                    ...
                                    @forelse ($faq as $item)
                                        <tr>
                                            ...
                                            <td class="no-sort no-click bread-actions">
                                                ...
                                                {!! Form::open(['url' => route('faq_delete', $item->id), 'method' => 'DELETE', 'id' => 'delete-form-'.$item->id, 'style' => 'display:none']) !!}
                                                {!! Form::close() !!}
                                                <a href="{{ route('faq.edit', $item->id) }}" title="Edit" class="btn btn-sm btn-primary pull-right edit">
